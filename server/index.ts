...
import { create1688BrowserSearch } from './sourcing/rpa-1688.browser'
...
const search1688 = process.env.SOURCING_1688_MODE === 'rpa'
  ? create1688BrowserSearch({ profileDir: resolve(dataDir, '1688-profile'), headless: process.env.SOURCING_1688_HEADLESS === 'true' })
  : undefined
