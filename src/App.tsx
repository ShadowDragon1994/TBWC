...
const nav = [[Home, '今日工作台'], [Radar, '趋势选品'], [MessagesSquare, '客服助手'], [Box, '商品库'], [Archive, '创作记录'], [CalendarDays, '发布任务'], [BarChart3, '数据复盘'], [Lightbulb, '策略建议'], [Image, '模板与素材'], [Settings, '设置']] as const
...
export function App() {
  ...
  return <div className="app-shell">
    ...
    <main className={selectedNav === '客服助手' ? 'customer-active' : ''}>
