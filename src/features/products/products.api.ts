...
export const productsApi = {
  ...
  restoreArchive: (file: File) => {
    ...
    return api<{ data: { products: number; assets: number; creationRecords: number; publishingTasks: number; performanceRecords: number } }>('/api/backup/archive', { method: 'POST', body: data })
  },
}
